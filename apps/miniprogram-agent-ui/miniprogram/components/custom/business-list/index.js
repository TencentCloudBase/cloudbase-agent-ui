    ...
    attached() {
      ...
      if (name === "map_search_places") {
        ...
        if (content[0].type === "text") {
          ...
          const restaurants = contentData.results;
          this.setData({
            restaurants: restaurants.map((item, index) => ({
              ...item,
              image: this.getRandomImage(),
              description: `私房菜 ${item.city}${item.area} 私房菜打卡人气榜第${index + 1}名`,
              rating: 4.2,
              reviews: 1923 ,
            })),
          });
      ...
      //       reviews: 1923,
      //       description:
      //         "Island-inspired seafood, sushi & tropical drinks in festive indoor-outdoor digs with a harbor view.",
      //       phone: "(619) 437-4474",
      ...
      //       rating: 4.7,
      //       reviews: 819,
      //       description: "私房菜 光谷/东湖高新区 私房菜打卡人气榜第3名",
      //       phone: "(027) 1234-5678",
      //       address: "武汉市光谷大道123号",
      //       image: this.getRandomImage(),
      //     },
      ...
      //       rating: 4.7,
      //       reviews: 1338,
      //       description: "湖北菜 光谷/东湖高新区 湖北菜口味榜第10名",
      //       phone: "(027) 8765-4321",
      //       address: "武汉市光谷大道456号",
      //       image: this.getRandomImage(),
      //     },
