...
1. **拷贝源码组件，将 agent-ui 组件放入用户项目 components 目录中**
2. **组件所属页面 .json配置文件中注册组件**
...
| `modelName`      | `String` | 条件 | `type=model` | 大模型服务商标识：`deepseek`/`hunyuan-open`                                                                                                                                                                                                                                                       |
